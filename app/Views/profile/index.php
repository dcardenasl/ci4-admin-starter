        ...
        <?php else: ?>
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="mt-1 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-800"><?= esc($user['firstName'] ?? '') ?></p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700"><?= lang('Profile.lastNameLabel') ?></label>
                    <p class="mt-1 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-800"><?= esc($user['lastName'] ?? '') ?></p>
                </div>
            </div>
